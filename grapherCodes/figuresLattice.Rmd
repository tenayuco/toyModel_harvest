...
FIG_INF <- DF_TOTAL_AG %>%
  ...
  geom_ribbon(aes(ymin=FrecCUM- SDFrec, ymax=FrecCUM+SDFrec, group= SimID, 
                  fill= porcionCosecha), color= "black")+
  xlim(0, 20)+
  #ylim(0, 0.45)+
...
#  theme(legend.position = "none")+
  ...
  theme(legend.position="bottom")+
      labs(fill= "Harvesting Scenario", x= 'Step length', y= "Proportion of Steps", color= "Harvesting scenario")


 ggsave(FIG_INF,filename=paste("../../output/graficas/DIF_RUST/", "INF_HAR.png", sep=""),  height = 10, width = 10)
