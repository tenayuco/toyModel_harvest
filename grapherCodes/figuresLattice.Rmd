...
#  theme(legend.position = "none")+
  ...
  theme(legend.position="bottom")+
      labs(fill= "Harvesting Scenario", x= 'Step length', y= "Proportion of Infective steps", color= "Harvesting scenario")


 ggsave(FIG_INF,filename=paste("../../output/graficas/DIF_RUST/", "INF_HAR.png", sep=""),  height = 12, width = 12)
