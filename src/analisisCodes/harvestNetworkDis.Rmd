...
ggsave(FIG_HIST_HAR_2,filename=paste("../../output/graficas/SUP_FIG/", "NetHar2.png", sep=""),  height = 8, width = 28) # ID will be the unique identifier. and change the extension from .png to whatever you like (eps, pdf etc).
```
...
FIG_CUM_HAR_2 <- DF_HIST_HAR %>%
 ...
 scale_fill_manual(values = mycols2)+
  ...
  labs(
    ...
    color=  "Harvesting Scenario",
    x = bquote("Size of network"), 
    y = "Cumulative % of infected plants AH"
  ) 


ggsave(FIG_CUM_HAR_2,filename=paste("../../output/graficas/SUP_FIG/", "CumHar2.png", sep=""),  height = 8, width = 28) # ID will be the unique identifier. and change the extension from .png to whatever you like (eps, pdf etc).
